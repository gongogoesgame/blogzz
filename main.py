...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://blogzz:helloworld@Localhost:8889/blogzz'
app.config['SQLALCHEMY_ECHO'] = True
db = SQLAlchemy(app)
app.secret_key = 'hey_there!'
...
def home():
    ...
    return render_template('home.html', title= "Welcome To Blogz", 
